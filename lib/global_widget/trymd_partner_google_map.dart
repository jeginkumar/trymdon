...
class TrymdPartnerMarker {
  const TrymdPartnerMarker(this.markerId, this.location, [this.onTap]);
  final String markerId;
  final latlng.LatLng location;
  final Future Function() onTap;
}

class TrymdPartnerGoogleMap extends StatefulWidget {
  const TrymdPartnerGoogleMap({
    this.controller,
    this.onCameraIdle,
  ...
  final Iterable<TrymdPartnerMarker> markers;
  ...
  @override
  State<StatefulWidget> createState() => _TrymdPartnerGoogleMapState();
}

class _TrymdPartnerGoogleMapState extends State<TrymdPartnerGoogleMap> {
