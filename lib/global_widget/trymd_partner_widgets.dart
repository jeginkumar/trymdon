...
class TrymdButtonOptions {
  const TrymdButtonOptions({
    this.textStyle,
    this.elevation,
    this.height,
    this.width,
...
class TrymdButtonWidget extends StatefulWidget {
  const TrymdButtonWidget({
    Key key,
    @required this.text,
  ...
  final TrymdButtonOptions options;
  final bool showLoadingIndicator;

  @override
  State<TrymdButtonWidget> createState() => _TrymdButtonWidgetState();
}

class _TrymdButtonWidgetState extends State<TrymdButtonWidget> {
  bool loading = false;
