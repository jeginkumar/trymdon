...
class TrymdPartnerDropDown extends StatefulWidget {
  const TrymdPartnerDropDown({
    this.initialOption,
    this.hintText,
  ...
  @override
  State<TrymdPartnerDropDown> createState() => _TrymdPartnerDropDownState();
}

class _TrymdPartnerDropDownState extends State<TrymdPartnerDropDown> {
