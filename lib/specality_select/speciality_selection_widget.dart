...
class SpecialitySelectionWidget extends StatefulWidget {
  final vendorType;
  ...
  @override
  _SpecialitySelectionWidgetState createState() =>
      _SpecialitySelectionWidgetState();
}

class _SpecialitySelectionWidgetState extends State<SpecialitySelectionWidget> {
    ...
    Navigator.pushReplacement(
      ...
      PageRouteBuilder(
        pageBuilder: (context, animation1, animation2) =>
            CategorySelectionWidget(vendorType: "professional"),
  ...
  void initState() {
    ...
    if (dummyData != null) {
      ...
      if (storage.getItem("selectedSpList") != null) {
        selectedSpeciality = storage.getItem("selectedSpList");
      }
    }
    specialityFunction();
  }
  ...
  Widget specialityLists(context, data) {
    return InkWell(
      onTap: () {
        setState(() {
        ...
        // setState(() {
        //   if (selectedSpeciality == data["speciality_id"]) {
        //     selectedSpeciality = "";
        //   } else if (selectedSpeciality != data["speciality_id"]) {
        //     selectedSpeciality = data["speciality_id"];
        //   }
