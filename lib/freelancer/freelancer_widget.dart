...
class FreelancerWidget extends StatefulWidget {
  const FreelancerWidget({Key key}) : super(key: key);

  @override
  _FreelancerWidgetState createState() => _FreelancerWidgetState();
}

class _FreelancerWidgetState extends State<FreelancerWidget> {
                      ...
                      children: [
                        ...
                        Padding(
                            ...
                            child: TabBar(
                              ...
                              indicatorPadding: EdgeInsetsDirectional.fromSTEB(
                        ...
                        Padding(
                          ...
                          child: Container(
                            height: SizeConfig.blockSizeVertical * 104,
                            child: TabBarView(
                                controller: _tabController,
                                physics: NeverScrollableScrollPhysics(),
                                dragStartBehavior: DragStartBehavior.down,
                                children: [freelancer(), fulltime()]),
                          ),
                        ),
                        // Padding(
                        //   padding: EdgeInsetsDirectional.fromSTEB(
                        ...
                        //         SizeConfig.blockSizeVertical * 1.5, 0, 0),
                        //     child: Container(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              colors: tabIndex == 0
                  ? [Color(0xFF2BA4F9), Color(0xFF07D0F2)]
        ...
        children: [
          Container(
            ...
            child: Column(mainAxisSize: MainAxisSize.max, children: [
              ...
              //       //   context,
              //       //   MaterialPageRoute(
              //       //     builder: (context) => FDARegistrationScreen(),
              //       //   ),
              //       // );
              //     },
              //     child: Container(
              ...
              //           Padding(
              //             padding:
              //                 EdgeInsetsDirectional.fromSTEB(0, 20, 140, 0),
              //             child: Text(
              //               'COMMING',
              //               style:
            ...
            //           labelStyle: TextStyle(color: Color(0xFF0B2F45)),
            ...
            //               hintStyle: TextStyle(color: Color(0xFF0B2F45)),
            ...
            //               suffixIcon:
            //                   Icon(Icons.event_note, color: Color(0xC40B2F45)),
            //               enabledBorder: OutlineInputBorder(
            //                   borderSide: BorderSide(
            //                 color: Color(0xFFE5E5E5),
            //                 width: 1,
            ...
            //           ),
            //           Padding(
            //             padding: EdgeInsetsDirectional.fromSTEB(90, 70, 0, 0),
            //             child: Material(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
                      ...
                      onChanged: (newVal) {
                        setState(() {
                          ...
                          vendorList.forEach((element) {
                            if (element['vendor_name'] == selectedvendorName) {
                              selectedVendorNumber = element['vendor_number'];
                            }
                          });
            ...
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(
                  0, SizeConfig.blockSizeVertical * 1.5, 0, 0),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                mainAxisSize: MainAxisSize.max,
                children: [
                    ...
                    onTap: () {
                      setState(() {
                        if (showAvailableContentTwo.length == 0 ||
                          ...
                          showAvailableContentTwo = "male";
                        } else if (showAvailableContentTwo == "male") {
                        ...
                        InkWell(
                          onTap: () {
                            setState(() {
                              if (showAvailableContentTwo.length == 0 ||
                                ...
                                showAvailableContentTwo = "female";
                              } else if (showAvailableContentTwo == "female") {
                                showAvailableContentTwo = "";
                              }
                            });
                          },
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(56),
                              border: Border.all(
                                color: showAvailableContentTwo == "female"
                                    ? Color(0xFF3F8BFD)
                                    : Color(0XFFE5E5E5),
                              ),
                            ),
            ...
            Row(
                ...
                children: [
                  Stack(children: [
                        ...
                        child: FutureBuilder<XFile>(
                          ...
                          builder: (context, snap) {
                            if (snap.hasData) {
                              ...
                              int dd = idx.length;
                              imageString = idx[dd - 1].replaceAll("'", "");
                              return Container(
                                width: SizeConfig.blockSizeHorizontal * 35,
                    ...
                    Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(100, 70, 0, 0),
                      child: Material(
                        color: Colors.transparent,
                        elevation: 2,
                        shape: const CircleBorder(),
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'Email ID',
                  labelStyle: TrymdPartnerTheme.of(context).bodyText1.override(
                        fontFamily: 'geometric sans-serif',
                        color: Color(0xFF000000),
                        fontSize: SizeConfig.blockSizeVertical * 1.7,
                        fontWeight: FontWeight.w400,
      ...
      if (_formFulltime.currentState.validate()) {
        if (showAvailableContentTwo.length == 0) {
          ...
          var jsonBody = ({
            ...
            "professional_year": textController4.text,
          ...
          if (response['status'] == 1) {
            ...
            _globalWidget.toastMessage('Could not update profile');
          }
        }
      }
    }
