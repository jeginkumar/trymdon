...
// import 'package:trymd_partner/dashboard/newmyprofile.dart';
// import 'package:trymd_partner/dashboard/expand.dart';
...
import 'package:trymd_partner/fda_screens/fda_home.dart';
...
class FDADashboardWidget extends StatefulWidget {
  const FDADashboardWidget({Key key}) : super(key: key);

  @override
  State<FDADashboardWidget> createState() => FDADashboardWidgetState();
}

class FDADashboardWidgetState extends State<FDADashboardWidget> {
        ...
        child: Scaffold(
          ...
          bottomNavigationBar: Container(
            decoration: const BoxDecoration(
              ...
              //   topLeft: Radius.circular(Sizes.radius0,),
              //   topRight: Radius.circular(Sizes.radius0,),
              // ),
              boxShadow: [
                BoxShadow(
              ...
              child: Padding(
                ...
                child: GNav(
                  ...
                  tabs: const [
                    ...
                    GButton(icon: Icons.book, text: 'GENERATE\nBOOKINGS'),
