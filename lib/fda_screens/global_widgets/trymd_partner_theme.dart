...
abstract class TrymdPartnerTheme {
  ...
  static TrymdPartnerTheme of(BuildContext context) =>
...
class LightModeTheme extends TrymdPartnerTheme {
...
class DarkModeTheme extends TrymdPartnerTheme {
  Color primaryColor = const Color(0xFF4B39EF);
  Color secondaryColor = const Color(0xFF39D2C0);
  Color tertiaryColor = const Color(0xFFEE8B60);
  Color alternate = const Color(0xFFFF5963);
