...
class TrymdPartnerChoiceChips extends StatefulWidget {
  const TrymdPartnerChoiceChips({
  ...
  @override
  State<TrymdPartnerChoiceChips> createState() =>
      _TrymdPartnerChoiceChipsState();
}

class _TrymdPartnerChoiceChipsState extends State<TrymdPartnerChoiceChips> {
