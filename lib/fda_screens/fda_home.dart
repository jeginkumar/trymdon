...
class FdaHomeScreen extends StatefulWidget {
  FdaHomeScreen({Key key}) : super(key: key);

  @override
  _FdaHomeScreenState createState() => _FdaHomeScreenState();
}

class _FdaHomeScreenState extends State<FdaHomeScreen> {
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TrymdPartnerChoiceChips(
                                    initiallySelected: ["Absent"],
                                    options: [
                                      ChipData('Absent'),
                                      ChipData('Present')
                                    ],
                                    ...
                                    selectedChipStyle: ChipStyle(
                                      backgroundColor: Color(0xA80DD439),
                                      textStyle: TextStyle(
                                        fontFamily: 'Harmonia Sans W01 bold',
                                        color: Colors.white,
                                        fontSize: 12,
                                    ...
                                    unselectedChipStyle: ChipStyle(
                                      backgroundColor: Color(0xFFCCD2E3),
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => BookingIDWidget(),
                    ),
                  );
                },
                child: Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [Color(0xFF07D0F2), Color(0xFF477FFF)],
                        stops: [0, 1],
