...
class TrymdPartnerRadioButton extends StatefulWidget {
  const TrymdPartnerRadioButton({
  ...
  @override
  State<TrymdPartnerRadioButton> createState() =>
      _TrymdPartnerRadioButtonState();
}

class _TrymdPartnerRadioButtonState extends State<TrymdPartnerRadioButton> {
  String groupValue;
