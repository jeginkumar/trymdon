...
class DashboardBankWidget extends StatefulWidget {
  final vendorType;
  DashboardBankWidget({this.vendorType});

  @override
  _DashboardBankWidgetState createState() => _DashboardBankWidgetState();
}

class _DashboardBankWidgetState extends State<DashboardBankWidget>
...
//       data.forEach((ele) {
//         slotDurations.add(ele['duration'],);
//       });
//     }
//     taxList = ["5", "12", "18"];
//     setState(() {});
...
updateBankDetailsFun(jsondata) async {
  ...
  if (response['status'] == 1) {
    ...
    Fluttertoast.showToast(
        msg: "Could not update bank details",
        toastLength: Toast.LENGTH_SHORT,
        gravity: ToastGravity.SNACKBAR,
        timeInSecForIosWeb: 1,
        backgroundColor: Colors.black54,
