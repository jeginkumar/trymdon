...
class TrymdPartnerDropDownOne extends StatefulWidget {
  const TrymdPartnerDropDownOne({
    this.initialOption,
  ...
  @override
  State<TrymdPartnerDropDownOne> createState() =>
      _TrymdPartnerDropDownOneState();
}

class _TrymdPartnerDropDownOneState extends State<TrymdPartnerDropDownOne> {
  String dropDownValue;
  List get effectiveOptions =>
  ...
  Widget build(BuildContext context) {
    final dropdownWidget = DropdownButton(
